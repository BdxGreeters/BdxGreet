...
from cluster.models import Experience_Greeter, InterestCenter
from destination.models import List_places
...
class Greeter(models.Model):
    ...
    age_greeter=models.ForeignKey(TrancheAge, on_delete=models.PROTECT,limit_choices_to={'id__gt': 2},verbose_name=_("Tranche d'âge"),help_text=_("Saisir la tranche d'âge du Greeter"))
    experiences_greeters=models.ManyToManyField(Experience_Greeter,verbose_name=_('Expériences de Greeter'),help_text=_("Cocher les expériences de Greeter"))
    photo = models.ImageField (upload_to ='photos_profil/',default='photos_profil/default.jpg',blank=True,null=True, verbose_name=_('Photo de profil'), help_text=_("Taille : 200 px *200 px"))
    bio_greeter=models.TextField(max_length=1500,default="",verbose_name=_('Biographie'),blank=True,null=True, help_text=_("Saisir la biographie du Greeter"))
    ...
    langues_parlées_greeter=models.ManyToManyField(LangueParlee,default="",verbose_name=_('Langues parlées'),help_text=_("Saisir les langues parlées du Greeter"))
    ...
    disponibility_day_greeter=MultiSelectField(choices=choices_day,max_length=100,default="Lundi, Mardi, Mercredi, Jeudi, Vendredi, Samedi, Dimanche",verbose_name=_('Jours de disponibilité'),help_text=_("Cocher les jours de disponibilité du Greeter")) # Lundi, Mardi, Mercredi, Jeudi, Vendredi, Samedi, Dimanche
    disponibility_time_greeter=models.ManyToManyField(Periode,max_length=100,default="",verbose_name=_('Disponibilité en journée'),help_text=_("Cocher les périodes de disponibilité en journée du Greeter"))
    indisponibilty=models.BooleanField(default=False,verbose_name=_('Indisponible'),help_text=_("Cocher si le Greeter est actuellement indisponible"))
    begin_indisponibility=models.DateField(blank=True,null=True,verbose_name=_('Date de début d\'indisponibilité'),help_text=_("Saisir la date de début d'indisponibilité du Greeter"))
    end_indisponibility=models.DateField(blank=True,null=True,verbose_name=_('Date de fin d\'indisponibilité'),help_text=_("Saisir la date de fin d'indisponibilité du Greeter"))
