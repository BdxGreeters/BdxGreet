...
urlpatterns = [
    ...
    path('<int:pk>/', destination_views.DestinationDetailView.as_view(), name='destination_detail'),
    path('<int:pk>/edit/', destination_views.DestinationUpdateView.as_view(), name='destination_update'),
