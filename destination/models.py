...
from core.models import Language_communication,Beneficiaire
from modeltranslation.translator import translator,register,TranslationOptions
from cluster.models import Cluster
from core.models import LangueDeepL,InterestCenter, LangueParlee, Pays, No_show, Periode, TrancheAge, Types_handicap, Language_communication
...
class Destination_flux(models.Model):
    ...
    flux_delai_organsiation_dest=models.IntegerField(default=0, verbose_name=_("Nombre de jours minimum avant la date de la balade"), help_text=_("Saisir le nombre de jours minimum avant la date de la balade"))
