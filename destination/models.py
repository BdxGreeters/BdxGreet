...
class Destination(models.Model):
    ...
    URL_retry_dest=models.URLField(default=None, verbose_name=_('URL de retour'), help_text=_("Saisir l'URL de retour après la validation d'une demande"))
...
class List_places(models.Model):
    list_places_dest=models.CharField(max_length=500,default=" ",verbose_name=_("Lieu ou thème "),blank=True, null=True,help_text=_("Saisir le lieu ou thème"))
    
    def __str__(self):
        return f"{self.list_places_dest}"
...
class Destination_data(models.Model):
    ...
    param_comment_visitor_dest=models.TextField(max_length=1000,blank=True,null=True,verbose_name=_("Présentation des commentaires pour le visiteur"),help_text=_("Saisir la présentation des commentaires pour le visiteur à l'inscription"))
