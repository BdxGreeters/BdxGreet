...
class Cluster(models.Model):
    ...
    country_admin_cluster=models.ForeignKey(Pays,on_delete=models.SET_NULL,related_name=  "country_admin_cluster",null=True, blank=True, verbose_name=_("Pays"),help_text=_("Saisir le pays de l'administrateur"))
    ...
    country_admin_alt_cluster= models.ForeignKey(Pays,on_delete=models.SET_NULL,related_name="country_admin_alt_cluster",null=True,blank=True, verbose_name=_("Pays"), help_text=_("Saisir le pays de l'admnistrateur alternatif"))
