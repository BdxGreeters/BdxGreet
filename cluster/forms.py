                ...
                Tab(
                    ...
                    Fieldset(
                        ...
                        Row(
                            ...
                            Column(HTML(f'<button type="button" class="btn btn-sm btn-primary ms-2" data-target-field="id_admin_cluster" data-pending-field="id_pending_adm_id">{_("Nouvel utilisateur")}</button>'),
                    ...
                    Fieldset(
                        ...
                        Row(
                            ...
                            Column(HTML(f'<button type="button" class="btn btn-sm btn-primary ms-2" data-target-field="id_admin_alt_cluster" data-pending-field="id_pending_adm_alt_id">{_("Nouvel utilisateur")}</button>'),
                                   css_class="d-flex align-items-center")
                        ),
                        Row(
